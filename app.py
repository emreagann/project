...
if uploaded_file is not None:
    ...
    for index, row in df.iterrows():
        linguistic_values_alternatives[row['Alternatives']] = row[['αα', 'αβ', 'αY', 'βα', 'ββ', 'βY', 'γα', 'γβ', 'YY']].values.tolist()

    linguistic_values_weights = {}
    for index, row in weights_df.iterrows():
        linguistic_values_weights[row['Weights']] = row[['αα', 'αβ', 'αY', 'βα', 'ββ', 'βY', 'γα', 'γβ', 'YY']].values.tolist()
